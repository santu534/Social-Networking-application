...
public class CntryLangAdapter extends BaseAdapter {
	...
	public CntryLangAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(val.length() == 0)
			val = item.getAttribute("album_name");
		if(val.length() == 0)
			val = item.getAttribute("userName");		
